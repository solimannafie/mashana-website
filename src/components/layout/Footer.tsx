        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products?category=bread" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Bread</Link></li>
              <li><Link to="/products?category=pastries" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Pastries</Link></li>
              <li><Link to="/products?category=cakes" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Cakes</Link></li>
            </ul>
          </div>
